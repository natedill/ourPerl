...
# usage:
#
# tpxoBoundaryInterp.pl --gridfile /path/to/fort.14 --tpxofile /path/to/h_tpxo7.2 --constituents m2,s2,n2,k2,k1,o1,p1,q1 --outfile tidal_boundary_data.txt
#
...
use lib 'C:/ourPerl/AdcircUtils'; # this needs to point to the directory
